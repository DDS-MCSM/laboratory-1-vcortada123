...
Data Driven Security aims to provide an introduction to computer security field, but from a different perspective.
...
_Create a new R file (just a normal file with .R extension). Write some R code. If you don't have any idea, you can always copy the following R program:_
